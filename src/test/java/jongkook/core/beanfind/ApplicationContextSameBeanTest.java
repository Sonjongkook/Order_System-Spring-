...
public class ApplicationContextSameBeanTest {
    ...
    @Test
    @DisplayName("If there are two identical type, duplicate error! ")
    ...
    @Test
    @DisplayName("If there are two same named type, assign blank")
    void findBeanByName() {
    ...
    @Test
    @DisplayName("Search all specific types")
