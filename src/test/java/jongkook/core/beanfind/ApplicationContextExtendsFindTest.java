...
public class ApplicationContextExtendsFindTest {
    ...
    @Test
    @DisplayName("Duplicate error pop up, when two same children class exist from parent class")
    ...
    @Test
    @DisplayName("Assign bean name, when two same children class exist from parent class")
    ...
    @Test
    @DisplayName("Find bean by sup type")
    ...
    @Test
    @DisplayName("Search by Object type")
